...
try:
    ...
    while True:
        ...
        new_rgbd_image = open3d.geometry.RGBDImage.create_from_color_and_depth(
            open3d.geometry.Image(raw_rgb), open3d.geometry.Image(raw_depth))
        ...
        pcd = open3d.geometry.PointCloud.create_from_rgbd_image(new_rgbd_image, intrinsic)
